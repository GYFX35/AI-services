...
const AI_SERVICES: AIService[] = [
  ...
  { id: 'domain-codex', name: 'Domain Codex Designer', category: 'Infrastructure', icon: Globe, description: 'Design custom domains and USSP configurations using Codex-level AI.' },
